...
- The two production models (`claude-sonnet-4-6` and `claude-opus-4-6` via the Anthropic API directly) are fixed. New model proposals require explicit CTO approval.
