...
First build downloads the Python 3.12 slim image, installs system packages (git, curl, gh CLI, Dart Sass), installs Python dependencies, and compiles SCSS. Expect **2–5 minutes** on a cold build.
